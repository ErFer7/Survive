release: src/vector2D.c src/core.c src/utilities.c src/graphics.c src/interface.c src/entity.c src/world.c main.c
	@echo Building the game with release options.
	gcc src/vector2D.c src/core.c src/utilities.c src/graphics.c src/interface.c src/entity.c src/world.c main.c -o Survive -O3 -s -DNDEBUG -fopenmp
...
debug: src/core.c src/utilities.c src/core.c src/graphics.c src/interface.c src/entity.c src/world.c main.c
	...
	gcc src/vector2D.c src/core.c src/utilities.c src/graphics.c src/interface.c src/entity.c src/world.c main.c -o Survive -O3 -g -Wall -fopenmp
